...
class sdParams(): # SD-specific metadata
    sdNum = 1 # SD id number
    sdSer = '1022' # SD Name
    sdEKSer = 264033 # WBT-Mini serial number
    sdXducerSer = 106 # Combi serial number
    sdMissionStart = '20180706' #'20180714' # 'YYYYMMDD' format of the starting date for making EV files (with buffer)
...
class evParams(): # Echoview specific needs
    ...
    dataAcousticDir = '..\\..\\data\\EK80\\arctic-2018\\echosounder\\sd-1022\\' # directory of *.raw data
    dataGPSDir = '..\\..\\data\\EK80\\arctic-2018\\gps_csv\\1022\\'# directory of *.gps.csv data
    outputDir = '..\\..\\data\\EV\\EVFiles\\SD1022\\' # directory for created EV files
    evTemplateFile = '..\\..\\data\\EV\\SD_2018_template.EV' # EV template for file creation
    calFile = '..\\..\\data\\Calibration\\SD1022_Set6_2018Mission_Final.ecs' # ecs file for specific wbat
